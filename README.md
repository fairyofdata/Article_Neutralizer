...
> [경요세계(瓊瑤世界)](https://www.seoul.co.kr/news/editOpinion/world-stories/2024/07/12/20240712035005) : 1643년 조선통신사 박안기가 시즈오카현 청견사에 남긴 편액의 문구로 '두 개의 옥구슬이 서로 비춘다'는 뜻

**프로젝트 수행 목적**  
이 프로젝트는 한일관계를 다룬 양국의 뉴스 기사를 크롤링하여 한일 간 이슈에 대한 중립적인 시각을 제공하는 것을 목표로 합니다. Streamlit을 기반으로 한 사용자 인터페이스(UI)를 통해 기사 크롤링, 분류, 요약 및 중립 기사 생성의 모든 프로세스를 직관적으로 체험할 수 있습니다.
...
### 1. **크롤링 시작**
   - 메인 화면의 **Jungang 기사 수집** 또는 **Yomiuri 기사 수집** 버튼을 클릭하여 각 언론사로부터 키워드(각각 '한일', '日韓')에 맞는 기사를 수집합니다.
